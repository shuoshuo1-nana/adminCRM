    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#convertSelectSurplusActivityRelation").keydown(function (event) {
                ...
                if (event.keyCode == 13) {
                    var name = $.trim($("#convertSelectSurplusActivityRelation").val());
                    $.ajax({
                        url: "workbench/activity/convertSelectSurplusActivityRelation.do",
                        data: {
                            "name": name,
                            "id": "${param.id}"
                        },
                        ...
                        success: function (data) {
                            ...
                            $("#convertShowContactsActivityRelation").html(html);
        ...
        function convertShowContactsActivityRelation() {
            $.ajax({
