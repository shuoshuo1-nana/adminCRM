...
<head>
    ...
    <script type="text/javascript">
        ...
        function correlationActivity() {
            ...
            $.ajax({
                url: "workbench/activity/showSurplusActivityRelation.do",
                data: {
                    "id": "${clue.id}"
                },
                type: "get",
...
<div>
    <div style="position: relative; top: 60px; left: 40px;">
        ...
        <div>
            <a href="javascript:void(0);" onclick="correlationActivity()" style="text-decoration: none;"><span
