    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#ClueBtn").click(function () {
                ...
                $.ajax({
                    url: "workbench/activity/showUserName.do",
                    dataType: "json",
                    type: "get",
                    cache: false,
        ...
        function addClueBtn() {
            $("#addClueBtn").click(function () {
                $.ajax({
                    url:"workbench/activity/addClue.do",
                    type:"post",
                    data:{
                        /*
    ...
    <div class="modal-dialog" role="document" style="width: 90%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="addClueBtn">保存</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar"
            ...
            <div class="btn-group" style="position: relative; top: 18%;">
                <button type="button" class="btn btn-primary" data-toggle="modal" id="ClueBtn"><span
