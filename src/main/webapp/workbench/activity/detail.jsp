                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.flag) {
                            ...
                            html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                            html += '<a class="myHref" href="javascript:void(0);"><span onclick="deleteRemark(\'' + data.arr.id + '\')" class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>';
                            html += '</div>';
                            html += '</div>';
                            html += '</div>';
